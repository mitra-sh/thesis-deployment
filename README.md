...
This example corresponds to one specific scenario. For every scenario, the topology class (and sometimes the packaged jar itself) needs to be changed to match the experiment being run.
